...
public class TeacherController {
  ...
  public ResponseEntity changeStandingYears(@RequestBody StandingYearsDto standingYearsDto) {
    return ResponseEntity.status(HttpStatus.ACCEPTED)
        .body(editTeacher.changeStandingYears(standingYearsDto));
  }

  @PutMapping("{teacherId}/activate/")
  public ResponseEntity activateTeacher(@PathVariable long teacherId) {
    return ResponseEntity.status(HttpStatus.ACCEPTED).body(editTeacher.activate(teacherId));
  }

  @PutMapping("deactivate/")
  public ResponseEntity deactivateTeacher(@RequestBody DeactivateDto deactivateDto) {
