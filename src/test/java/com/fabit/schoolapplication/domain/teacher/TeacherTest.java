...
class TeacherTest {
    ...
    void createTeacher_ValidData_shouldReturnValidObjectWithID1() {
        Teacher teacher = Teacher.create(1L, new FullName("Иван", "Иванов", "Иванович"), new Passport("1999", "89292"), new Snils("123-343-2231-32"), 10);
    ...
    void createTeacher_NonValidStandingYears_shouldThrowIllegalArgumentException() {
        Throwable thrown =
                assertThrows(
                        ...
                        () -> {
                            Teacher teacher = Teacher.create(1L, new FullName("Иван", "Иванов", "Иванович"), new Passport("1999", "89292"), new Snils("123-343-2231-32"), 71);
                        });
    }
