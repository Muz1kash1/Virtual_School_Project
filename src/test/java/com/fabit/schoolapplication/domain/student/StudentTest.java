...
class StudentTest {
  ...
  void createStudent12Years() {
    Student student = Student.create(1, "Петя Губкин", Snils.of("123-343-2231-32"),
  ...
  void createStudent15Years() {
    Student student =
        Student.create(1, "Петя Губкин", Snils.of("123-343-2231-32"), Passport.of("МК", "88888"),
  ...
  void createStudent12YearsWithPassportShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.create(1, "Петя Губкин", Snils.of("123-343-2231-32"),
  ...
  void changeSnils() {
    Student student =
        Student.create(1, "Петя Губкин", Snils.of("123-343-2231-32"), Passport.of("МК", "89292"),
            LocalDate.of(2007, 9, 15));
  ...
  void addPassport() {
    Student student =
        Student.create(1, "Петя Губкин", Snils.of("123-343-2231-32"), Passport.of("MK", "11111"),
            LocalDate.of(2007, 9, 15));
