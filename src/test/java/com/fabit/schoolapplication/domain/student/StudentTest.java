...
class StudentTest {
  ...
  void createStudent12Years() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        ...
        BirthCertificate.of("2222", "999999", LocalDate.of(2010, 9, 15)));
  ...
  void createStudent15Years() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        Snils.of("123-343-223-32"), RussianPassport.of("1111", "888888", LocalDate.of(2007, 9, 15)));
    assertEquals(1l, student.getId().getValue());
    assertEquals("Васильевич", student.getFullName().getPatronymic());
    assertEquals("123-343-223-32", student.getSnils().getNumberView());
  }
  ...
  void createStudent12YearsWithPassportShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
            Snils.of("123-343-223-32"), RussianPassport.of("1111", "888888", LocalDate.of(2010, 9, 15))));
  }
  ...
  void createStudentWithInvalidPassportShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
            Snils.of("123-343-223-32"), RussianPassport.of("99", "89292", LocalDate.of(2010, 9, 15))));
  }
  ...
  void createStudentWithInvalidBirthCertificateShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
            Snils.of("123-343-223-32"),
            BirthCertificate.of("99", "89292", LocalDate.of(2010, 9, 15))));
  }
  @Test
  ...
  void createStudent4YearsShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
            Snils.of("123-343-223-32"),
            BirthCertificate.of("2222", "999999", LocalDate.of(2018, 9, 15))));
  }
  ...
  void changeBirthCertificate() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        Snils.of("123-343-223-32"),
        BirthCertificate.of("2223", "788778", LocalDate.of(2007, 9, 15)));
    student.changeBirthCertificate(
        BirthCertificate.of("2222", "999999", LocalDate.of(2007, 9, 15)));
  ...
  void addPassport() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        Snils.of("123-343-223-32"), RussianPassport.of("2222", "999999", LocalDate.of(2007, 9, 15)));
    student.addPassport(RussianPassport.of("1111", "555555", LocalDate.of(2007, 9, 15)));
