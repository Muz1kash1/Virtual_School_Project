...
class StudentTest {
    ...
    void createStudent12Years() {
        Student student = Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), BirthCertificate.create("МК", "55555"), LocalDate.of(2010, 9, 15));
    ...
    void createStudent15Years() {
        Student student = Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), new Passport("МК", "88888"), LocalDate.of(2007, 9, 15));
        assertEquals(1l, student.getId());
        assertEquals("Петя Губкин", student.getName());
        assertEquals("123-343-2231-32", student.getSnils().getNumberView());
    }
    ...
    void createStudent12YearsWithPassportShouldThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), new Passport("МК", "89292"), LocalDate.of(2010, 9, 15)));
    }

    @Test
    @DisplayName("Изменяем снилс")
    void changeSnils() {
        Student student = Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), new Passport("МК", "89292"), LocalDate.of(2007, 9, 15));
    ...
    void changeBirthCertificate() {
        Student student = Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), BirthCertificate.create("МК", "89292"), LocalDate.of(2007, 9, 15));
    ...
    void addPassport() {
        Student student = Student.create(1, "Петя Губкин", new Snils("123-343-2231-32"), new Passport("MK", "11111"), LocalDate.of(2007, 9, 15));
