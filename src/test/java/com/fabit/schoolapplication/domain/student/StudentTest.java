...
class StudentTest {
  ...
  void createStudent12YearsWithPassportShouldThrowIllegalArgumentException() {
    assertThrows(IllegalArgumentException.class,
        () -> Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
            Snils.of("123-343-2231-32"), Passport.of("МК", "89292", LocalDate.of(2010, 9, 15))));
  }
  ...
  void changeBirthCertificate() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        Snils.of("123-343-2231-32"), BirthCertificate.of("МК", "89292", LocalDate.of(2007, 9, 15)));
    student.changeBirthCertificate(BirthCertificate.of("MK", "99999", LocalDate.of(2007, 9, 15)));
  ...
  void addPassport() {
    Student student = Student.of(StudentId.of(1), FullName.of("Петя", "Губкин", "Васильевич"),
        Snils.of("123-343-2231-32"), Passport.of("MK", "11111", LocalDate.of(2007, 9, 15)));
    student.addPassport(Passport.of("MK", "99999", LocalDate.of(2007, 9, 15)));
